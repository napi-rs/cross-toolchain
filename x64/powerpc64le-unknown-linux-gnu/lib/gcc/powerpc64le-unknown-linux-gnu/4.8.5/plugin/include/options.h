...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_EFFICIENT_UNALIGNED_VSX;
#else
  int x_TARGET_EFFICIENT_UNALIGNED_VSX;
#define TARGET_EFFICIENT_UNALIGNED_VSX global_options.x_TARGET_EFFICIENT_UNALIGNED_VSX
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_target_option
{
  ...
  signed char x_TARGET_EFFICIENT_UNALIGNED_VSX;
  unsigned char x_rs6000_float_gprs;
...
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1 << 22)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1 << 25)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1 << 27)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1 << 28)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1 << 30)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1 << 31)
...
enum opt_code
{
  ...
  OPT_fgnu_unique = 620,                     /* -fgnu-unique */
  ...
  OPT_m32 = 1039,                            /* -m32 */
  OPT_m64 = 1040,                            /* -m64 */
  OPT_mabi_altivec = 1041,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1042,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1043,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1044,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1045,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1046,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1047,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1048,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1049,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1050,                       /* -mabi=spe */
  OPT_mads = 1051,                           /* -mads */
  OPT_maix_struct_return = 1052,             /* -maix-struct-return */
  OPT_malign_ = 1053,                        /* -malign- */
  OPT_malign_branch_targets = 1054,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1055,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1056,             /* -mallow-movmisalign */
  OPT_maltivec = 1057,                       /* -maltivec */
  OPT_maltivec_be = 1058,                    /* -maltivec=be */
  OPT_maltivec_le = 1059,                    /* -maltivec=le */
  OPT_malways_hint = 1060,                   /* -malways-hint */
  OPT_mandroid = 1061,                       /* -mandroid */
  OPT_mavoid_indexed_addresses = 1062,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1063,                           /* -mbig */
  OPT_mbig_endian = 1064,                    /* -mbig-endian */
  OPT_mbionic = 1065,                        /* -mbionic */
  OPT_mbit_align = 1066,                     /* -mbit-align */
  OPT_mbit_word = 1067,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1068,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1069,                       /* -mbss-plt */
  OPT_mcall_ = 1070,                         /* -mcall- */
  OPT_mcmodel_ = 1071,                       /* -mcmodel= */
  OPT_mcmpb = 1072,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1073,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1074,                          /* -mcpu= */
  OPT_mcrypto = 1075,                        /* -mcrypto */
  OPT_mdebug_ = 1076,                        /* -mdebug= */
  OPT_mdirect_move = 1077,                   /* -mdirect-move */
  OPT_mdlmzb = 1078,                         /* -mdlmzb */
  OPT_mdouble_float = 1079,                  /* -mdouble-float */
  OPT_meabi = 1080,                          /* -meabi */
  OPT_mefficient_unaligned_vector = 1081,    /* -mefficient-unaligned-vector */
  OPT_memb = 1082,                           /* -memb */
  OPT_mfloat_gprs_ = 1083,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1084,                     /* -mfp-in-toc */
  OPT_mfprnd = 1085,                         /* -mfprnd */
  OPT_mfpu_ = 1086,                          /* -mfpu= */
  OPT_mfriz = 1087,                          /* -mfriz */
  OPT_mfull_toc = 1088,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1089, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1090,            /* -mgen-cell-microcode */
  OPT_mglibc = 1091,                         /* -mglibc */
  OPT_mhard_dfp = 1092,                      /* -mhard-dfp */
  OPT_mhard_float = 1093,                    /* -mhard-float */
  OPT_mhtm = 1094,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1095,            /* -minsert-sched-nops= */
  OPT_misel = 1096,                          /* -misel */
  /* OPT_misel_no = 1097, */                 /* -misel=no */
  /* OPT_misel_yes = 1098, */                /* -misel=yes */
  OPT_mlittle = 1099,                        /* -mlittle */
  OPT_mlittle_endian = 1100,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1101,                  /* -mlong-double- */
  OPT_mlongcall = 1102,                      /* -mlongcall */
  OPT_mlra = 1103,                           /* -mlra */
  OPT_mmfcrf = 1104,                         /* -mmfcrf */
  OPT_mmfpgpr = 1105,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1106,                   /* -mminimal-toc */
  OPT_mmulhw = 1107,                         /* -mmulhw */
  OPT_mmultiple = 1108,                      /* -mmultiple */
  OPT_mmusl = 1109,                          /* -mmusl */
  OPT_mmvme = 1110,                          /* -mmvme */
  OPT_mnewlib = 1111,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1112,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1113,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1114,                        /* -mno-toc */
  OPT_mno_traceback = 1115,                  /* -mno-traceback */
  OPT_mno_update = 1116,                     /* -mno-update */
  OPT_moptimize_swaps = 1117,                /* -moptimize-swaps */
  OPT_mpaired = 1118,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1119,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1120,                       /* -mpopcntb */
  OPT_mpopcntd = 1121,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1122,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1123,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1124,                 /* -mpower8-vector */
  /* OPT_mpowerpc = 1125, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1126,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1127,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1128,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1129,  /* -mprioritize-restricted-insns= */
  OPT_mprofile_kernel = 1130,                /* -mprofile-kernel */
  OPT_mprototype = 1131,                     /* -mprototype */
  OPT_mquad_memory = 1132,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1133,            /* -mquad-memory-atomic */
  OPT_mrecip = 1134,                         /* -mrecip */
  OPT_mrecip_precision = 1135,               /* -mrecip-precision */
  OPT_mrecip_ = 1136,                        /* -mrecip= */
  OPT_mregnames = 1137,                      /* -mregnames */
  OPT_mrelocatable = 1138,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1139,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1140,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1141,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1142,                  /* -msched-epilog */
  OPT_msched_groups = 1143,                  /* -msched-groups */
  OPT_msched_prolog = 1144,                  /* -msched-prolog */
  OPT_msdata = 1145,                         /* -msdata */
  OPT_msdata_ = 1146,                        /* -msdata= */
  OPT_msecure_plt = 1147,                    /* -msecure-plt */
  OPT_mshlib = 1148,                         /* -mshlib */
  OPT_msim = 1149,                           /* -msim */
  OPT_msimple_fpu = 1150,                    /* -msimple-fpu */
  OPT_msingle_float = 1151,                  /* -msingle-float */
  OPT_msingle_pic_base = 1152,               /* -msingle-pic-base */
  OPT_msoft_float = 1153,                    /* -msoft-float */
  OPT_mspe = 1154,                           /* -mspe */
  /* OPT_mspe_no = 1155, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1156, */                 /* -mspe=yes */
  OPT_mstrict_align = 1157,                  /* -mstrict-align */
  OPT_mstring = 1158,                        /* -mstring */
  OPT_msum_in_toc = 1159,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1160,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1161,                   /* -mtls-markers */
  OPT_mtls_size_ = 1162,                     /* -mtls-size= */
  OPT_mtoc = 1163,                           /* -mtoc */
  OPT_mtraceback_ = 1164,                    /* -mtraceback= */
  OPT_mtune_ = 1165,                         /* -mtune= */
  OPT_muclibc = 1166,                        /* -muclibc */
  OPT_mupdate = 1167,                        /* -mupdate */
  OPT_mupper_regs_df = 1168,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1169,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1170,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1171,            /* -mvectorize-builtins */
  OPT_mvrsave = 1172,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1173, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1174, */              /* -mvrsave=yes */
  OPT_mvsx = 1175,                           /* -mvsx */
  OPT_mvsx_align_128 = 1176,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1177,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1178,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1179, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1180,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1181,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1182,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1183,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1184,                     /* -mxl-compat */
  OPT_myellowknife = 1185,                   /* -myellowknife */
  OPT_n = 1186,                              /* -n */
  ...
  OPT_static_libstdc__ = 1235,               /* -static-libstdc++ */
  OPT_static_libtsan = 1236,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1237, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1238, */                /* -std=c++0x */
  OPT_std_c__11 = 1239,                      /* -std=c++11 */
  ...
  OPT_std_gnu__98 = 1257,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1258,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1259, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1260, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1261,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1262,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1263, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1264, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1265,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1266, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1267, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1268, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1269,                     /* -std=legacy */
  OPT_symbolic = 1270,                       /* -symbolic */
  OPT_t = 1271,                              /* -t */
  OPT_time = 1272,                           /* -time */
  OPT_time_ = 1273,                          /* -time= */
  OPT_tno_android_cc = 1274,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1275,                 /* -tno-android-ld */
  OPT_traditional = 1276,                    /* -traditional */
  OPT_traditional_cpp = 1277,                /* -traditional-cpp */
  OPT_trigraphs = 1278,                      /* -trigraphs */
  OPT_u = 1279,                              /* -u */
  OPT_undef = 1280,                          /* -undef */
  OPT_v = 1281,                              /* -v */
  OPT_version = 1282,                        /* -version */
  OPT_w = 1283,                              /* -w */
  OPT_wrapper = 1284,                        /* -wrapper */
  OPT_x = 1285,                              /* -x */
  OPT_z = 1286,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
