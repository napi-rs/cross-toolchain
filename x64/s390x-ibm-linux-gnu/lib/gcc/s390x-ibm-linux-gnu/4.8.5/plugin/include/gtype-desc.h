...
#define ggc_alloc_s390_frame_layout() ((struct s390_frame_layout *)(ggc_internal_alloc_stat (sizeof (struct s390_frame_layout) MEM_STAT_INFO)))
#define ggc_alloc_cleared_s390_frame_layout() ((struct s390_frame_layout *)(ggc_internal_cleared_alloc_stat (sizeof (struct s390_frame_layout) MEM_STAT_INFO)))
#define ggc_alloc_vec_s390_frame_layout(n) ((struct s390_frame_layout *)(ggc_internal_vec_alloc_stat (sizeof (struct s390_frame_layout), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_s390_frame_layout(n) ((struct s390_frame_layout *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct s390_frame_layout), n MEM_STAT_INFO)))
