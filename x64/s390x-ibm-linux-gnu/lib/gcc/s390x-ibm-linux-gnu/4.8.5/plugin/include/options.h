...
#include "config/s390/s390-opts.h"
...
#endif
#ifdef GENERATOR_FILE
extern HOST_WIDE_INT s390_warn_framesize;
#else
  HOST_WIDE_INT x_s390_warn_framesize;
#define s390_warn_framesize global_options.x_s390_warn_framesize
#endif
#ifdef GENERATOR_FILE
...
#else
  const char * x_s390_arch_string;
#define s390_arch_string global_options.x_s390_arch_string
#endif
#ifdef GENERATOR_FILE
...
#else
  int x_s390_arch_flags;
#define s390_arch_flags global_options.x_s390_arch_flags
#endif
#ifdef GENERATOR_FILE
extern int s390_tune_flags;
#else
  int x_s390_tune_flags;
#define s390_tune_flags global_options.x_s390_tune_flags
#endif
#ifdef GENERATOR_FILE
...
#else
  enum processor_type x_s390_arch;
#define s390_arch global_options.x_s390_arch
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int s390_branch_cost;
#else
  int x_s390_branch_cost;
#define s390_branch_cost global_options.x_s390_branch_cost
#endif
#ifdef GENERATOR_FILE
extern void *s390_deferred_options;
#else
  void *x_s390_deferred_options;
#define s390_deferred_options global_options.x_s390_deferred_options
#endif
#ifdef GENERATOR_FILE
extern int s390_stack_guard;
#else
  int x_s390_stack_guard;
#define s390_stack_guard global_options.x_s390_stack_guard
#endif
#ifdef GENERATOR_FILE
extern int s390_stack_size;
#else
  int x_s390_stack_size;
#define s390_stack_size global_options.x_s390_stack_size
#endif
#ifdef GENERATOR_FILE
extern enum processor_type s390_tune;
#else
  enum processor_type x_s390_tune;
#define s390_tune global_options.x_s390_tune
#endif
#ifdef GENERATOR_FILE
extern int s390_warn_dynamicstack_p;
#else
  int x_s390_warn_dynamicstack_p;
#define s390_warn_dynamicstack_p global_options.x_s390_warn_dynamicstack_p
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_mwarn_framesize_;
#define x_VAR_mwarn_framesize_ do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_BACKCHAIN (1 << 1)
#define MASK_DEBUG_ARG (1 << 2)
#define MASK_ZARCH (1 << 3)
#define MASK_HARD_DFP (1 << 4)
#define MASK_SOFT_FLOAT (1 << 5)
#define MASK_OPT_HTM (1 << 6)
#define MASK_LONG_DOUBLE_128 (1 << 7)
#define MASK_MVCLE (1 << 8)
#define MASK_PACKED_STACK (1 << 9)
#define MASK_SMALL_EXEC (1 << 10)

#define TARGET_64BIT ((target_flags & MASK_64BIT) != 0)
#define TARGET_ANDROID ((flag_android & OPTION_MASK_ANDROID) != 0)
#define TARGET_BACKCHAIN ((target_flags & MASK_BACKCHAIN) != 0)
#define TARGET_DEBUG_ARG ((target_flags & MASK_DEBUG_ARG) != 0)
#define TARGET_ZARCH ((target_flags & MASK_ZARCH) != 0)
#define TARGET_HARD_DFP ((target_flags & MASK_HARD_DFP) != 0)
#define TARGET_SOFT_FLOAT ((target_flags & MASK_SOFT_FLOAT) != 0)
#define TARGET_OPT_HTM ((target_flags & MASK_OPT_HTM) != 0)
#define TARGET_LONG_DOUBLE_128 ((target_flags & MASK_LONG_DOUBLE_128) != 0)
#define TARGET_MVCLE ((target_flags & MASK_MVCLE) != 0)
#define TARGET_PACKED_STACK ((target_flags & MASK_PACKED_STACK) != 0)
#define TARGET_SMALL_EXEC ((target_flags & MASK_SMALL_EXEC) != 0)
...
enum opt_code
{
  ...
  OPT_mbackchain = 1042,                     /* -mbackchain */
  OPT_mbionic = 1043,                        /* -mbionic */
  OPT_mbranch_cost_ = 1044,                  /* -mbranch-cost= */
  OPT_mdebug = 1045,                         /* -mdebug */
  OPT_mesa = 1046,                           /* -mesa */
  /* OPT_mfused_madd = 1047, */              /* -mfused-madd */
  OPT_mglibc = 1048,                         /* -mglibc */
  OPT_mhard_dfp = 1049,                      /* -mhard-dfp */
  OPT_mhard_float = 1050,                    /* -mhard-float */
  OPT_mhotpatch_ = 1051,                     /* -mhotpatch= */
  OPT_mhtm = 1052,                           /* -mhtm */
  OPT_mlong_double_128 = 1053,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1054,                /* -mlong-double-64 */
  OPT_mmusl = 1055,                          /* -mmusl */
  OPT_mmvcle = 1056,                         /* -mmvcle */
  OPT_mpacked_stack = 1057,                  /* -mpacked-stack */
  OPT_msmall_exec = 1058,                    /* -msmall-exec */
  OPT_msoft_float = 1059,                    /* -msoft-float */
  OPT_mstack_guard_ = 1060,                  /* -mstack-guard= */
  OPT_mstack_size_ = 1061,                   /* -mstack-size= */
  OPT_mtune_ = 1062,                         /* -mtune= */
  OPT_muclibc = 1063,                        /* -muclibc */
  OPT_mwarn_dynamicstack = 1064,             /* -mwarn-dynamicstack */
  OPT_mwarn_framesize_ = 1065,               /* -mwarn-framesize= */
  OPT_mzarch = 1066,                         /* -mzarch */
  OPT_n = 1067,                              /* -n */
  OPT_no_canonical_prefixes = 1068,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1069,              /* -no-integrated-cpp */
  OPT_nocpp = 1070,                          /* -nocpp */
  OPT_nodefaultlibs = 1071,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1072,                   /* -nostartfiles */
  OPT_nostdinc = 1073,                       /* -nostdinc */
  OPT_nostdinc__ = 1074,                     /* -nostdinc++ */
  OPT_nostdlib = 1075,                       /* -nostdlib */
  OPT_o = 1076,                              /* -o */
  OPT_p = 1077,                              /* -p */
  OPT_pass_exit_codes = 1078,                /* -pass-exit-codes */
  /* OPT_pedantic = 1079, */                 /* -pedantic */
  OPT_pedantic_errors = 1080,                /* -pedantic-errors */
  OPT_pg = 1081,                             /* -pg */
  OPT_pie = 1082,                            /* -pie */
  OPT_pipe = 1083,                           /* -pipe */
  OPT_posix = 1084,                          /* -posix */
  OPT_print_file_name_ = 1085,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1086,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1087,          /* -print-multi-directory */
  OPT_print_multi_lib = 1088,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1089,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1090,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1091,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1092,               /* -print-prog-name= */
  OPT_print_search_dirs = 1093,              /* -print-search-dirs */
  OPT_print_sysroot = 1094,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1095,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1096,                        /* -profile */
  OPT_pthread = 1097,                        /* -pthread */
  OPT_quiet = 1098,                          /* -quiet */
  OPT_r = 1099,                              /* -r */
  OPT_rdynamic = 1100,                       /* -rdynamic */
  OPT_remap = 1101,                          /* -remap */
  OPT_s = 1102,                              /* -s */
  OPT_s_bc_abi = 1103,                       /* -s-bc-abi */
  OPT_save_temps = 1104,                     /* -save-temps */
  OPT_save_temps_ = 1105,                    /* -save-temps= */
  OPT_shared = 1106,                         /* -shared */
  OPT_shared_libgcc = 1107,                  /* -shared-libgcc */
  /* OPT_specs = 1108, */                    /* -specs */
  OPT_specs_ = 1109,                         /* -specs= */
  OPT_static = 1110,                         /* -static */
  OPT_static_libasan = 1111,                 /* -static-libasan */
  OPT_static_libgcc = 1112,                  /* -static-libgcc */
  OPT_static_libgcj = 1113,                  /* -static-libgcj */
  OPT_static_libgfortran = 1114,             /* -static-libgfortran */
  OPT_static_libgo = 1115,                   /* -static-libgo */
  OPT_static_libstdc__ = 1116,               /* -static-libstdc++ */
  OPT_static_libtsan = 1117,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1118, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1119, */                /* -std=c++0x */
  OPT_std_c__11 = 1120,                      /* -std=c++11 */
  OPT_std_c__1y = 1121,                      /* -std=c++1y */
  OPT_std_c__98 = 1122,                      /* -std=c++98 */
  OPT_std_c11 = 1123,                        /* -std=c11 */
  /* OPT_std_c1x = 1124, */                  /* -std=c1x */
  /* OPT_std_c89 = 1125, */                  /* -std=c89 */
  OPT_std_c90 = 1126,                        /* -std=c90 */
  OPT_std_c99 = 1127,                        /* -std=c99 */
  /* OPT_std_c9x = 1128, */                  /* -std=c9x */
  OPT_std_f2003 = 1129,                      /* -std=f2003 */
  OPT_std_f2008 = 1130,                      /* -std=f2008 */
  OPT_std_f2008ts = 1131,                    /* -std=f2008ts */
  OPT_std_f95 = 1132,                        /* -std=f95 */
  OPT_std_gnu = 1133,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1134, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1135, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1136,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1137,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1138,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1139,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1140, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1141, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1142,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1143,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1144, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1145, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1146,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1147, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1148, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1149, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1150,                     /* -std=legacy */
  OPT_symbolic = 1151,                       /* -symbolic */
  OPT_t = 1152,                              /* -t */
  OPT_time = 1153,                           /* -time */
  OPT_time_ = 1154,                          /* -time= */
  OPT_tno_android_cc = 1155,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1156,                 /* -tno-android-ld */
  OPT_traditional = 1157,                    /* -traditional */
  OPT_traditional_cpp = 1158,                /* -traditional-cpp */
  OPT_trigraphs = 1159,                      /* -trigraphs */
  OPT_u = 1160,                              /* -u */
  OPT_undef = 1161,                          /* -undef */
  OPT_v = 1162,                              /* -v */
  OPT_version = 1163,                        /* -version */
  OPT_w = 1164,                              /* -w */
  OPT_wrapper = 1165,                        /* -wrapper */
  OPT_x = 1166,                              /* -x */
  OPT_z = 1167,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
